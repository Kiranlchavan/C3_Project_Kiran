...
class RestaurantServiceTest {
    ...
    public void searching_for_non_existing_restaurant_should_throw_exception() throws restaurantNotFoundException {
        Throwable exception = assertThrows(restaurantNotFoundException.class, new Executable() {
            @Override
            public void execute() throws Throwable {
                LocalTime openingTime = LocalTime.parse("10:30:00");
                LocalTime closingTime = LocalTime.parse("22:00:00");
                service.addRestaurant("Amelie's cafe","Chennai",openingTime,closingTime);
                String searchName = "Kiran's cafe";
                Restaurant restaurant = service.findRestaurantByName(searchName);
                String actName = restaurant.getName();

            }
        });
        assertEquals("Error:Restaurant could not be found", exception.getMessage());
    }
